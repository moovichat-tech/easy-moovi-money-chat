    ...
    <section className="py-16 md:py-20 bg-background">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8" ref={elementRef}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          {/* Com Moovi */}
          <div
            className={`bg-green-50 rounded-2xl p-8 border-2 border-green-200 fade-in-scroll fade-in-scroll-delay-200 ${isVisible ? "visible" : ""}`}
          >
          ...
          <div
            className={`bg-red-50 rounded-2xl p-8 border-2 border-red-200 fade-in-scroll ${isVisible ? "visible" : ""}`}
          >
            <h4 className="text-xl sm:text-2xl font-bold mb-6 flex items-center gap-3">
