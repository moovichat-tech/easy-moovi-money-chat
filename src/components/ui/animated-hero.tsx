        ...
        <div className="flex gap-2 flex-col">
          ...
          <p className="text-base leading-relaxed tracking-tight text-muted-foreground max-w-2xl text-center px-4 md:text-lg">
            ...
            <span className="block mt-1 text-sm md:text-base">
              Seu <span className="font-semibold text-primary">assessor financeiro 24h no WhatsApp</span>, mostra{" "}
              <span className="font-semibold text-primary">em tempo real</span> onde cada centavo está indo.
            </span>
          </p>
        </div>
      </div>
