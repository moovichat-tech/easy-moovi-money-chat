    ...
    <section id="pricing-section" className="py-20 bg-muted/30">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8" ref={elementRef}>
        ...
        <div className="text-center space-y-4 mb-12">
          ...
          <p className={`text-muted-foreground text-lg max-w-2xl mx-auto fade-in-scroll fade-in-scroll-delay-100 ${isVisible ? 'visible' : ''}`}>
          ...
          {plans.map((plan, index) => (
            ...
            >
              ...
              <Button
                asChild
                size="lg"
                variant={plan.isPopular ? "hero" : "secondary"}
