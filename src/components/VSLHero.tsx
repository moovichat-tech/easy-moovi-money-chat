...
const VSLHero = () => {
  ...
  return (
    <section className="relative pt-0 pb-4 md:py-8 lg:py-10 md:-mx-8 bg-gradient-to-br from-green-50 to-white overflow-hidden">
      {/* Floating Badges */}
        ...
        <div className="max-w-5xl mx-auto text-center">
          <div className={`space-y-3 fade-in-scroll ${isVisible ? "visible" : ""}`}>
            ...
            <div className="pt-3">
              <Button
                size="xl"
                className="bg-green-600 hover:bg-green-700 text-white font-bold text-xl px-12 py-8 shadow-2xl hover:shadow-3xl transition-all rounded-2xl hover:scale-105"
