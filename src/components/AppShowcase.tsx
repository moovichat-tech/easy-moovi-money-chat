...
export function AppShowcase() {
  ...
  const PANDA_VIDEO_URL = "https://player-vz-c1e2f242-e38.tv.pandavideo.com.br/embed/?v=4e6c28e8-f6eb-4e20-b216-224be1bc17f8";
    ...
    <section className="py-20 bg-white overflow-hidden">
      <div className="container mx-auto px-4" ref={elementRef}>
        ...
        `}>
          ...
          <div className="w-full max-w-[300px] md:w-1/3 md:translate-y-12 transition-all duration-500">
            <Iphone
