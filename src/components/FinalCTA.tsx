...
const FinalCTA = () => {
  ...
  return (
    <section id="cta-section" className="bg-primary">
      ...
      <div className="py-24">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-8">
            ...
            <Button 
              size="xl" 
              className="bg-white hover:bg-gray-50 text-primary shadow-xl group text-base px-12"
              onClick={scrollToCTA}
            >
              Testar grátis agora
            ...
            {/* Trust indicators */}
            <div className="flex flex-wrap items-center justify-center gap-6 text-white/90 pt-4">
      ...
      {/* Footer integrated */}
      <div className="bg-primary/90 border-t border-white/10 py-12">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
