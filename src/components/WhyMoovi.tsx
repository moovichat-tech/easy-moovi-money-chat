      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div className="relative">
            ...
            <div className="absolute top-8 right-8 bg-white rounded-xl shadow-xl p-4 animate-float max-w-[200px]">
            ...
            <div className="absolute bottom-16 left-8 bg-white rounded-xl shadow-xl p-4 animate-float-delayed max-w-[240px]">
